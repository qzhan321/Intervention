...
*** Sample database output ***
    ...
    void initialize_sample_db() {
        ...
        sqlite3_exec(sample_db,
                     ...
                     "time REAL, pop_id INTEGER, n_infections INTEGER, n_infected INTEGER, n_infected_bites INTEGER, n_total_bites INTEGER, n_circulating_strains INTEGER, n_circulating_genes INTEGER, exec_time REAL, n_infected_bites_with_space INTEGER"
                     ");",
                     NULL, NULL, NULL
        );
