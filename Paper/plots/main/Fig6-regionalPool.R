...
sizeV <- 25
pointSize <- 1.25
p1 <- ggplot(dfAll %>% filter(migration == "Baseline Migration Rate"), 
...
saveDir0 <- "/project2/pascualmm/QZ/PhD/projects/intervention/natComRevision/plots/figures/main/Fig6/prevalenceDynamicsTransientIRSPool/"
