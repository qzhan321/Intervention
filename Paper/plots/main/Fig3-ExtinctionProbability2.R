...
saveDir0 <- paste0("/project2/pascualmm/QZ/PhD/projects/intervention/natComRevision/plots/figures/main/Fig3/extinctionProb2/")
...
for (i in 1:length(seasonality)) {
  ...
  for (j in 1:length(openness)) {
    ...
    print(p1)
    ggsave(paste0(saveDir2, min(nums), "-", max(nums), "_extinctionProbability.pdf"), p1, width = 7.5/1.2, height = 6/1.2)
  }
}
