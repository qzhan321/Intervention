...
states <- c("withME")
saveDir0 <- "/project2/pascualmm/QZ/PhD/projects/intervention/natComRevision/plots/figures/supp/fig24/MOI/"
...
for (i in 1:length(PTSTypes)) {
  ...
  load(file1)
  file2 <- paste0(readDir0, "Ghana", "_PTSType_", PTSType, "-excludeDrug.RData")
  load(file2)
