...
prefix=survey
readDir0=/project2/pascualmm/QZ/PhD/projects/intervention/natComRevision/files/figures/main/Fig5/MOI/MOIEstInputs
saveDir0=/project2/pascualmm/QZ/PhD/projects/intervention/natComRevision/files/figures/main/Fig5/MOI/MOIEst
if [ -d "$saveDir0" ]; then
  echo "folder exists!"
else
  mkdir $saveDir0
...
MOIEstDir=/home/qizhan/others/PhD/projects/BayesianMOI/github/round2/Bayesian-formulation-varcoding-MOI-estimation-main/scripts
